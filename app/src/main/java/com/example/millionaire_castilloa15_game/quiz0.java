        ...
        but_quiz1.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v){
                        ...
                        AlertDialog.Builder alertDlg = new AlertDialog.Builder(quiz0.this);
                        ...
                        alertDlg.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String answer = "CIVIL WAR";

                                if (rad_b.getText().toString().equals(answer)){

                                    String q1 = "Question 10: Correct ~ "+answer;
                                    SharedPreferences sp = getSharedPreferences("MyPref", Context.MODE_PRIVATE);
                                    int q1string = sp.getInt("QUIZRESULT", 0);

                                    result=q1string+100000;

                                    Toast.makeText(quiz0.this,q1,Toast.LENGTH_SHORT).show();
                                    //Saves user input
                                    ...
                                    startActivity(new Intent(quiz0.this, winner.class));
                                ...
                                //If the answer is wrong
                                    ...
                                    String q1 = "Question 10: Wrong ~ "+rad_b.getText().toString();
                                    Toast.makeText(quiz0.this, q1,Toast.LENGTH_SHORT).show();
                                    ...
                                    editor.putInt("QUIZRESULT",result);
                                    editor.commit();
                                    startActivity(new Intent(quiz0.this, wrongAns.class));
